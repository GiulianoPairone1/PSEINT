	...
	Repetir
		...
		Si op >0 Y op <6 Entonces
			Segun op Hacer
				...
				3:
					ordenaremple(nomn_Empleado,edad_emple,cuilem,cantempledo)
				4:
					ordenaredad(nomn_Empleado,edad_emple,cuilem,cantempledo)
			Fin Segun
		SiNo
...
SubProceso ordenaremple(nomn_Empleado,edad_emple,cuilem,cantempledo)
...
SubProceso ordenaredad(nomn_Empleado,edad_emple,cuilem,cantempledo)
	Definir  pos_menor,i,j Como Entero
	Definir  aux Como Caracter
	Para i <- 0 Hasta cantempledo -2
		pos_menor<-i
