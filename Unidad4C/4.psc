Proceso sin_titulo
	...
	Mostrar "1-Buscar paciente"
	Mostrar "2-Mostrar el listado de pacientes ordenados  "
	Mostrar "3- Buscar paciente por apellido y nombre"
	Leer op
	Segun op Hacer
		1:
		...
		3:
			Mostrar "Ingrese el apellido y nombre del paciente"
			Leer  apenom
			CargaDatos(personas)	
			OrdenSeleccion(personas,8)
			buscar(personas,8, apenom)
	Fin Segun
FinProceso
...
FinSubProceso
SubProceso buscar(personas, dim, apenom)
	...
	Repetir 
		...
		si inferior > superior
			Mostrar  "Apellido y nombre no validos"
		FinSi
